...
public class FacultyController {
    ...
    public Collection<Faculty> getFaculties(
            @RequestParam @Parameter(description = "Цвет факультета для поиска", example = "Gryffindor Red") String color
    ) {
    ...
    @Operation(
            ...
            description = "Изменяет параметры существующего факультета. В теле запроса обязателен корректный ID."
    )
